...
def parse_args():
    ...
    elif config == 'cifar100_l2p_diverse':
        from configs.cifar100_l2p_diverse import get_args_parser
        config_parser = subparser.add_parser('cifar100_l2p_diverse', help='Split-CIFAR100 L2P Diverse configs')
    else:
